...
class main1 extends Thread
{
	...
	public void run()
	{
		try
		{
			...
			while(true)
			{
				System.out.println("CLient : "+d.readUTF());
				Thread.sleep(200);
			}
...
class web  
{
	...
	/*public static void main(String[] args) 
	{
		main1 m = new main1();
		while(m.flag);
		String initialPage = new String(m.msg);

		if (args.length > 0) initialPage = args[0];

		web b = new web(initialPage);
	}*/
...
class main1 extends Thread
{
	...
	public static void main(String args[])
	{
		...
		String h = new String("https://google.com");
		//new web(h);
		new main1();
